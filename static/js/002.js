...
function preview_html()
{
	...
	$('<p class="list">4.1	乙方应当以电子邮件的方式向甲方指定的联络人以及指定的电子邮箱交付合同约定的创作成果的可修改、编辑的电子文档。</p>').appendTo(index);
	$('<p class="list">4.2	甲方自收到乙方任意一阶段创作成果之日起'+GetVal($('input[name="002-069"]'))+'日内向乙方提出修改意见，逾期未提出修改意见的视为甲方认可乙方的创作成果。乙方应当在双方确定的修改期限内完成相关创作成果的修改并交付甲方。甲方对剧本的审核通过以甲方明示的书面（含电子邮件方式）确认为准。</p>').appendTo(index);
	...
	if ('none'!= $('[data-switch="002-081"][data-toggle="否"]').css('display'))
	{
		...
		if ('none'!= $('[data-switch="002-019"][data-toggle="受托方为公司 受托方为工作室"]').css('display'))
		{
			$('<p>本条确定的创作报酬为不含税金额，甲方支付任意一笔报酬时应当同时向乙方支付该笔款项'+GetVal($('input[name="002-089"]'))+'%的税金。乙方应当自收任意一笔报酬及其税金之日起的'+GetVal($('input[name="002-090"]'))+'内，甲方开具合法有效的'+$('input:radio[name="002-091"]:checked').val()+'。</p>').appendTo(index);
